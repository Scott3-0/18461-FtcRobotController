/*
Code taken from C. Porter of FTC 4628

Original code can be found at: https://github.com/cporter/ftc_app/blob/vv/autonomous-testing/TeamCode/src/main/java/com/suitbots/vv/Controller.java
*/
...
public class ControllerLib {
    ...
    public float left_stick_x, right_stick_x, left_stick_y, right_stick_y; //why were these doubles
    public float left_trigger, right_trigger;

    public ControllerLib(Gamepad g) {
        gamepad = g;
    }
